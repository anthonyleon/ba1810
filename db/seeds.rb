...
while (i < 16)
  ...
  Auction.create(company_id: i, part_num: parts_database[i-1][1], active: true, condition: rand(0..4), destination_address: Faker::Address.street_address, destination_zip: Faker::Address.zip, destination_city: Faker::Address.city_suffix, destination_country: Faker::Address.country, required_date: Faker::Date.forward(23))
...
while (i < 29)
	...
	Engine.create(engine_major_variant: Faker::StarWars.planet, engine_minor_variant: Faker::StarWars.planet,
		esn: Faker::Company.ein, condition: rand(1..3), current_status: "in service",
