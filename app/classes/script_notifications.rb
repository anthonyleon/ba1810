class ScriptNotifications
    def run
        ...
        m = ["You have won an auction! Please finalize tax and shipping costs, and input your invoice number.", "Seller has finalized costs. Please send funds to escrow."]
        ...
        m.each { |b| Notification.where(message: b).each { |n| n.update(category: :action_required) } }
    end
