class AuctionsController < ApplicationController
  ...
  private
    ...
    def auction_params
      params.require(:auction).permit(:company_id, :part_num, :destination_shop, :destination_address, :destination_zip, :destination_city, :destination_state, :destination_country, :required_date, :resale_status, :resale_yes, :resale_no, condition: [])
    end
