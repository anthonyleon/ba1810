...
RSpec.describe AircraftsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all aircrafts as @aircrafts" do
      ...
      expect(assigns(:aircrafts)).to eq([aircraft])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested aircraft as @aircraft" do
      ...
      expect(assigns(:aircraft)).to eq(aircraft)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new aircraft as @aircraft" do
      ...
      expect(assigns(:aircraft)).to be_a_new(Aircraft)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created aircraft as @aircraft" do
        post :create, {:aircraft => valid_attributes}, valid_session
        expect(assigns(:aircraft)).to be_a(Aircraft)
        expect(assigns(:aircraft)).to be_persisted
      end
